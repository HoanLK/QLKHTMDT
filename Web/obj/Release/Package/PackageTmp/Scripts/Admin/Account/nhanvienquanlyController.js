admin.controller("nhanvienquanlyController", ['$scope', '$http', '$cookies', '$window', '$location', function ($scope, $http, $cookies, $window, $location) {
    //---VAR---
    $scope.currentUser = {};
    var roleManage = 'nhanvienquanly';
    //Account
    $scope.accounts = [];
    $scope.account = {};
    ...
    $scope.titlePopupModifyAccount = "Sửa thông tin người dùng";
    ...
    $scope.AddAccount = function () {
        $window.location.href = "/Account/AddNhanVienQuanLy";
    }
    //Edit
    ...
    $scope.SaveAccount = function (e) {
        ...
        $http.get(apiAccount + "/" + $scope.account.Id)
            .then(function success(response) {
                ...
                account.KhachHang_ID = $scope.account.KhachHang_ID;
                //Lưu qua API
    ...
    $scope.ConfirmDeleteAccount = function () {
        $scope.account = angular.copy($scope.selectedAccounts[0]);
        $window.location.href = "/Account/DeleteNhanVienQuanLy/" + $scope.account.Id;
        $scope.deleteAccount = false;
    };
